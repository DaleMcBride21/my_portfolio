...
The second half of each questions(give more of an explaination), remove the random sentences, use a different algorithm and compare the two of them, elevator pitch, check for misspellings
...
_My name usage throughout the years has changed significantly as it nears my birth month. In 1958 is where the name peaked in usage and after that it dropped off significantly. When I was born I was only one out of four hundred and ten named Dale that year._
...
#| fig-align: center
# Include and execute your code here
chart = px.scatter(df.query('name == "Dale"'),
    x="year", 
    y="Total",
...
#| fig-align: center
# Include and execute your code here
chart = px.scatter(df.query('name == "Brittany"'),
    x="year", 
    y="Total",
...
#| fig-align: center
# Include and execute your code here
chart = px.scatter(df.query('name == ["Mary", "Martha", "Peter", "Paul"]'),
    x="year", 
    y="Total",
    color = 'name',
    title = 'Name Usage'

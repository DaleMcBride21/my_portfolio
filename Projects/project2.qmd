...
replace_nan_df.dropna(inplace=True)

replace_nan_df = replace_nan_df.groupby('airport_code').agg('sum')# this should select airport code and combine all of the same airport data together
...
#remove any places where the month variable is missing
#I need to groupby airport and by each month
#then get the total amount of minutes delayed total by month
